// -------------------------------------------------------
	// Assignment 2
	// Question: MissingQuotesException class
	...
	/*
	The `MissingQuotesException` class handles cases where movie records contain excessive fields. 
	...
	This class enhances error handling by aiding in the identification and management of movie records with missing quotes.
	 */
// -------------------------------------------------------
package assignment2;
...
public class MissingQuotesException extends Exception{
	 /**
     * Constructs a new MissingQuotesException with a default message.
     */
	...
	/**
     * Constructs a new MissingQuotesException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public MissingQuotesException(String type, String record, String inputFile, int pos) {
		try {
