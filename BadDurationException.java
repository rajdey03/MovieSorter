// -------------------------------------------------------
	// Assignment 2
	// Question: BadDurationException class
...
/**
The `BadDurationException` class is a custom exception used to handle cases where a movie's duration is invalid. 
It extends the standard `Exception` class and provides constructors for creating instances of this exception. 
This exception class aids in identifying and handling instances where movie duration data does not meet the required criteria, 
enhancing the robustness of the movie management system.
*/
public class BadDurationException extends Exception{
	/**
     * Constructs a new BadDurationException with a default message.
     */
	...
	/**
     * Constructs a new BadDurationException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public BadDurationException(String type, String record, String inputFile, int pos) {
		try {
