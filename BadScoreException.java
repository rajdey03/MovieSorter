// -------------------------------------------------------
	// Assignment 2
	// Question: BadScoreException class
...
public class BadScoreException extends Exception{
	 /**
     * Constructs a new BadScoreException with a default message.
     */
	...
	/**
     * Constructs a new BadScoreException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public BadScoreException(String type, String record, String inputFile, int pos) {
		try {
