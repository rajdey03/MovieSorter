// -------------------------------------------------------
	// Assignment 2
	// Question: BadRatingException class
...
/**
The `BadRatingException` class is a custom exception used to handle cases where a movie's rating is invalid. 
It extends the standard `Exception` class and provides constructors for creating instances of this exception. 
This exception class aids in identifying and handling instances where movie rating does not meet the required criteria, 
enhancing the robustness of the movie management system.
*/
public class BadRatingException extends Exception {
	/**
     * Constructs a new BadRatingException with a default message.
     */
	...
	/**
     * Constructs a new BadRatingException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public BadRatingException(String type, String record, String inputFile, int pos) {
		try {
