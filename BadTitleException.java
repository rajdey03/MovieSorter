// -------------------------------------------------------
	// Assignment 2
	// Question: BadTitleException class
...
/**
The `BadTitleException` class is a custom exception used to handle cases where a movie's title is invalid. 
It extends the standard `Exception` class and provides constructors for creating instances of this exception. 
This exception class aids in identifying and handling instances where movie title data does not meet the required criteria, 
enhancing the robustness of the movie management system.
*/
public class BadTitleException extends Exception{
	/**
     * Constructs a new BadTitleException with a default message.
     */
	...
	/**
     * Constructs a new BadTitleException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public BadTitleException(String type, String record, String inputFile, int pos) {
		try {
