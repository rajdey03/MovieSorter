// -------------------------------------------------------
	// Assignment 2
	// Question: BadNameException class
...
/**
The `BadNameException` class is a custom exception used to handle cases where a movie's director or actor names are invalid. 
It extends the standard `Exception` class and provides constructors for creating instances of this exception. 
This exception class aids in identifying and handling instances where movie director or actor names do not meet the required criteria, 
enhancing the robustness of the movie management system.
*/
public class BadNameException extends Exception {
	/**
     * Constructs a new BadNameException with a default message.
     */
	...
	/**
     * Constructs a new BadNameException with a custom message and logs the exception details to a file.
     *
     ...
     */
	public BadNameException(String type, String record, String inputFile, int pos) {
		try {
